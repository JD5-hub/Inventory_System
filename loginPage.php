...
if (isset($_SESSION['userid'])) {
	header("location:".DOMAIN."/dashboard2.php");
}
?>
<!DOCTYPE html>
<html>
		  ...
		  <div class="card-body">
		    <form action="getLogin.php" method="POST">
			  <div class="form-group">
			    ...
			    <input type="email" class="form-control" name="log_email" placeholder="Enter email">
			  ...
			  <span><a href="registerPage.php">Register</a></span>
			</form>
