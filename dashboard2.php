			...
			<div class="col-md-4">
				<div class="card mx-auto">
				  ...
				  <div class="card-body">
				    ...
				    <p class="card-text"><i class="fa fa-user">&nbsp;</i>Nazer Malaguia</p>
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="card">
						...
						<p class="card-text">Manage brands and add new ones</p>
			...
			<div class="col-md-4">
				<div class="card">
						...
						<p class="card-text">Manage products and add new to the list</p>
